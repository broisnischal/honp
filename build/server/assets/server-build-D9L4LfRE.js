import { _ as __exportAll, a as Links, c as Scripts, d as redirect, f as useActionData, g as __commonJSMin, h as require_react, i as Link, l as ScrollRestoration, m as withComponentProps, o as Meta, p as useLoaderData, r as Form, s as Outlet, t as ServerRouter, u as data } from "./chunk-2UH5WJXA-D-rj_f57.js";
...
var root_default = withComponentProps(function AppRoot() {
...
var home_default = withComponentProps(function HomePage() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "Payment App Pattern" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "React Router v7 framework mode + CF Worker APIs + Better Auth + D1/Drizzle." }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
				to: "/auth",
				children: "Auth page"
...
//#endregion
//#region node_modules/up-fetch/dist/index.js
...
var withTimeout = (signal, timeout) => "any" in AbortSignal ? AbortSignal.any([signal, timeout && AbortSignal.timeout(timeout)].filter(Boolean)) : signal;
var omit = (obj, keys = []) => {
	const copy = { ...obj };
	for (const key in copy) keys.includes(key) && delete copy[key];
	return copy;
};
...
var resolveUrl = (base = "", input, defaultOptsParams, fetcherOptsParams, serializeParams) => {
	...
	const qs = serializeParams({
		...omit(defaultOptsParams, [...new URL(input, "http://a").searchParams.keys()]),
		...fetcherOptsParams
	});
	let url = /^https?:\/\//.test(input) ? input : !base || !input ? base + input : base.replace(/\/$/, "") + "/" + input.replace(/^\//, "");
	if (qs) url += (url.includes("?") ? "&" : "?") + qs.replace(/^\?/, "");
	return url;
};
...
async function toStreamable(reqOrRes, onChunk) {
	...
	if (isWebkit && !isResponse || !onChunk || !reqOrRes.clone().body) return reqOrRes;
	const contentLength = reqOrRes.headers.get("content-length");
	let totalBytes = contentLength ? +contentLength : void 0;
	if (!isResponse && !contentLength) totalBytes = (await reqOrRes.clone().arrayBuffer()).byteLength;
	...
	return isResponse ? new Response(stream, reqOrRes) : new Request(reqOrRes, {
		body: stream,
		duplex: "half"
	});
}
...
var up = (fetchFn, getDefaultOptions = () => emptyOptions) => async (input, fetcherOpts = emptyOptions, ctx) => {
	...
	do {
		...
		request = await toStreamable(new Request(input.url ? input : resolveUrl(options.baseUrl, input, defaultOpts.params, fetcherOpts.params, options.serializeParams), options), fetcherOpts.onRequestStreaming);
		try {
			await defaultOpts.onRequest?.(request);
			await fetcherOpts.onRequest?.(request);
			response = await toStreamable(await fetchFn(request, {
				...omit(options, ["body"]),
				headers: request.headers
			}, ctx), fetcherOpts.onResponseStreaming);
			error = void 0;
		} catch (e) {
			error = e;
		}
		try {
			if (!await options.retry.when({
				request,
				response,
				error
			}) || ++attempt > (typeof options.retry.attempts === "function" ? await options.retry.attempts({ request }) : options.retry.attempts)) break;
			const retryCtx = {
				attempt,
				request,
				response,
			...
			await abortableDelay(typeof options.retry.delay === "function" ? await options.retry.delay(retryCtx) : options.retry.delay, options.signal);
	...
	try {
		...
		if (await options.reject(response)) throw await options.parseRejected(response, request);
		...
		await defaultOpts.onError?.(error2, request);
		await fetcherOpts.onError?.(error2, request);
		throw error2;
	}
};
//#endregion
//#region app/lib/upfetch.server.ts
...
async function loader$1({ request }) {
	return { session: await createApi(request)("/api/session") };
}
async function action$1({ request }) {
	...
	if (intent === "sign-up") {
		...
		return data({
			ok: response.ok,
			message: response.ok ? "Account created" : "Sign up failed"
		}, {
	...
	if (intent === "sign-in") {
		...
		return data({
			ok: response.ok,
			message: response.ok ? "Signed in" : "Sign in failed"
		}, {
			status: response.ok ? 200 : 400,
			headers: { "set-cookie": response.headers.get("set-cookie") ?? "" }
		});
	...
	if (intent === "sign-out") {
		...
		return data({
			ok: response.ok,
			message: response.ok ? "Signed out" : "Sign out failed"
		}, {
			status: response.ok ? 200 : 400,
			headers: { "set-cookie": response.headers.get("set-cookie") ?? "" }
		});
...
var auth_default = withComponentProps(function AuthPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "Auth" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Simple email/password auth flow pattern." }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: ["Session user: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: session?.user?.email ?? "Not signed in" })] }),
			result?.message ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: result.message }) : null,
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Form, {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "Sign Up" }),
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "Sign In" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							type: "hidden",
							name: "intent",
							value: "sign-in"
...
async function loader({ request }) {
	...
	const [products, rows] = await Promise.all([api("/api/products"), api("/api/orders")]);
	return {
		session,
		products,
		rows
...
async function action({ request }) {
	const form = await request.formData();
	await createApi(request)("/api/orders", {
		method: "POST",
		body: {
...
var orders_default = withComponentProps(function OrdersPage() {
	const { session, products, rows } = useLoaderData();
	const result = useActionData();
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		style: {
			maxWidth: 860,
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: ["Signed in as ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: session.user?.email })] }),
			result?.message ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: result.message }) : null,
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Form, {
				method: "post",
				style: {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "Create Order" }),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { children: rows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
				...
				")"
			] }, `${row.orderId}-${row.productName ?? "item"}`)) }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
				to: "/auth",
...
var server_manifest_default = {
	"entry": {
		"module": "/assets/entry.client-zn5JQ394.js",
		"imports": ["/assets/jsx-runtime-Cd_Qtgf3.js"],
		"css": []
	},
	"routes": {
		"root": {
			...
			"module": "/assets/root-B9XOmJhy.js",
			"imports": ["/assets/jsx-runtime-Cd_Qtgf3.js"],
			"css": [],
		...
		"routes/home": {
			...
			"hasDefaultExport": true,
			"hasErrorBoundary": false,
			"module": "/assets/home-ChPldT83.js",
			"imports": ["/assets/jsx-runtime-Cd_Qtgf3.js"],
			"css": [],
			"clientActionModule": void 0,
			"clientLoaderModule": void 0,
		...
		"routes/auth": {
			...
			"hasDefaultExport": true,
			"hasErrorBoundary": false,
			"module": "/assets/auth-mXRzSxJi.js",
			"imports": ["/assets/jsx-runtime-Cd_Qtgf3.js"],
			"css": [],
			"clientActionModule": void 0,
			"clientLoaderModule": void 0,
		...
		"routes/orders": {
			...
			"hasDefaultExport": true,
			"hasErrorBoundary": false,
			"module": "/assets/orders-C7JGMGU0.js",
			"imports": ["/assets/jsx-runtime-Cd_Qtgf3.js"],
			"css": [],
			"clientActionModule": void 0,
			"clientLoaderModule": void 0,
	...
	"url": "/assets/manifest-1ce487bc.js",
	"version": "1ce487bc",
	"sri": void 0
};
//#endregion
