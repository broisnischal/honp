import { t as createAdapterFactory } from "./factory-4-lhSYWt.js";
import { A as isBoolean, B as noop, C as SchemableIdentifierNode, E as IdentifierNode, F as isNumber, I as isObject, M as isDate, N as isFunction, O as freeze, P as isNull, R as isString, T as ON_COMMIT_ACTIONS, i as CreateViewNode, j as isBuffer, k as isBigInt, m as RawNode, n as DEFAULT_MIGRATION_TABLE, o as WithSchemaPlugin, p as logOnce, r as DefaultQueryCompiler, s as OperationNodeTransformer, t as DEFAULT_MIGRATION_LOCK_TABLE, w as CreateTableNode, z as isUndefined } from "./migrator-G0qMzVBq.js";
import { C as parseStringReference, D as isOperationNodeSource, E as ColumnNode, S as parseOrderedColumnName, T as SelectAllNode, _ as QueryNode, a as parseExpression, b as ValueListNode, c as CaseNode, d as QueryExecutorBase, f as provideControlledConnection, g as SelectQueryNode, h as randomString, i as DynamicTableBuilder, l as createFunctionModule, m as createQueryId, n as sql, o as parseDataTypeExpression, p as Deferred, r as parseTable, s as CaseBuilder, t as CompiledQuery, u as QueryCreator, v as parseValueBinaryOperationOrExpression, w as DynamicReferenceBuilder, x as parseColumnName, y as ValueNode } from "./compiled-query-Btli8YR3.js";
import { n as SqliteQueryCompiler, r as DialectAdapterBase, t as SqliteAdapter } from "./sqlite-adapter-dARigZRU.js";
...
var createKyselyAdapter = async (config) => {
	...
	if ("fileControl" in db) {
		const { BunSqliteDialect } = await import("./bun-sqlite-dialect-na--YwnN-C3Su-G6v.js");
	...
	if ("createSession" in db) {
		...
		if (DatabaseSync && db instanceof DatabaseSync) {
			const { NodeSqliteDialect } = await import("./node-sqlite-dialect-DW65YD66.js");
			dialect = new NodeSqliteDialect({ database: db });
		}
	}
	if ("batch" in db && "exec" in db && "prepare" in db) {
		const { D1SqliteDialect } = await import("./d1-sqlite-dialect-C2B7YsIT-DgSE6wON.js");
